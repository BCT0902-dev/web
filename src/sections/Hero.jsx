    ...
    ? config.social_links.filter(s => s.isVisible !== false).map(s => ({
        ...
        renderableIcon: s.iconUrl ? <img src={s.iconUrl} alt={s.name} style={{ width: '20px', height: '20px', objectFit: 'contain' }} /> : (
          s.name.toLowerCase().includes('messenger') ? <MessageSquare size={20} /> : (
            ...
            s.name.toLowerCase().includes('telegram') ? <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg> :
            s.name.toLowerCase().includes('tiktok') ? <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5"></path></svg> :
            s.name.toLowerCase().includes('zalo') ? <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M22.05 10.3c-.05-1.55-1.12-2.85-2.6-3.14-1.63-.33-3.23.51-3.77 2.01-.15.36-.21.78-.18 1.16.06.66.33 1.25.76 1.74-.82 1.62-1.83 3.12-3.03 4.54-1.2-1.42-2.21-2.92-3.03-4.54.43-.49.7-1.08.76-1.74.03-.38-.03-.8-.18-1.16-.54-1.5-2.14-2.34-3.77-2.01-1.48.29-2.55 1.59-2.6 3.14-.02.43.05.86.2 1.27.42 1.13 1.45 1.94 2.67 2.04v2.96c0 .35.28.63.63.63.17 0 .33-.07.45-.19l2.45-2.43c1.37.08 2.76.12 4.14.12 1.38 0 2.77-.04 4.14-.12l2.45 2.43c.12.12.28.19.45.19.35 0 .63-.28.63-.63v-2.96c1.22-.1 2.25-.91 2.67-2.04.15-.41.22-.84.2-1.27z"/></svg> :
            s.name.toLowerCase().includes('reddit') ? <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M17 12a5 5 0 0 0-10 0"></path><line x1="12" y1="7" x2="12" y2="12"></line></svg> :
            s.name.toLowerCase().includes('spotify') ? <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M8 12c2-1 4-1 8 0"></path><path d="M7 15c3-1 6-1 10 0"></path><path d="M9 9c2-1 3-1 6 0"></path></svg> :
            s.name.toLowerCase().includes('twitch') ? <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 2H3v16h5v4l4-4h5l4-4V2z"></path><line x1="11" y1="7" x2="11" y2="11"></line><line x1="16" y1="7" x2="16" y2="11"></line></svg> :
            s.name.toLowerCase().includes('snapchat') ? <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8.19 11.79a3.78 3.78 0 0 0 7.62 0"></path><path d="M12 2v20"></path></svg> :
            s.name.toLowerCase().includes('pinterest') ? <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M12 8c-2 0-3 1-3 3 0 1 1 3 1 3s-1 1-1 3c0 1 1 2 2 2 1 0 3-4 3-6 0-2-1-3-2-3z"></path></svg> :
            s.name.toLowerCase().includes('slack') ? <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="13" y="2" width="3" height="8" rx="1.5"></rect><rect x="19" y="9" width="3" height="8" rx="1.5"></rect><rect x="8" y="14" width="3" height="8" rx="1.5"></rect><rect x="2" y="7" width="3" height="8" rx="1.5"></rect></svg> :
            s.name.toLowerCase().includes('dribbble') ? <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M8.5 8.5c2 2 5 2 7 0"></path><path d="M8.5 15.5c2-2 5-2 7 0"></path><path d="M12 2v20"></path></svg> :
            <Globe size={20} />
          )
        )
      }))
