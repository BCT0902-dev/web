            ...
            {socials.map((social, idx) => (
              <a 
                ...
                onMouseOver={(e) => {
                  ...
                  e.currentTarget.style.background = `${social.brandColor}11`;
                  if (icon) icon.style.color = social.brandColor;
                  e.currentTarget.querySelector('span').style.color = social.brandColor;
                }}
                onMouseOut={(e) => {
                  const icon = e.currentTarget.querySelector('svg');
